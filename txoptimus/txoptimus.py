...
/_/ /_/|_| \____/ .___/\__/_/_/ /_/ /_/\__,_/____/  
    ...
    PrimeKG + OptimusKG | by arsalanriaz38[AT]gmail[DOT]com
"""
...
Examples:
  ...
  txoptimus --setup optimus
    ...
    parser.add_argument("--low-memory", action='store_true', default=False,
                        help="Use gradient attribution instead of GraphMask for interpretation (OptimusKG only)")
...
def run_comparison(prime_results: dict, optimus_results: dict,
    ...
    report_lines.extend(["", "---", f"*Generated by TxOptimus v0.1.8*", ""])
